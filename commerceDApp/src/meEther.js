...
const meEther = module.exports = {
    ...
    //Dai
    DAI_CONTRACT_ADDR: '0x1142b6FBAC052869fbC12849C37dA289033b87EA',
    ...
    // pass
    //
    purchaseDeposit: function(escrowIdBN, productIdBN, surchargeBN, msgFee, attachmentIdxBN, messageHex, cb) {
	...
	const abiParms = meEther.abiEncodePurchaseDepositParms(escrowIdBN, productIdBN, surchargeBN, attachmentIdxBN, messageHex);
	...
	if (!meEther.purchaseDepositABI)
	    meEther.purchaseDepositABI = ethabi.methodID('purchaseDeposit', [ 'uint256', 'uint256', 'uint256', 'uint256', 'bytes' ]).toString('hex');
	return(meEther.purchaseDepositABI);
    },

    abiEncodePurchaseDepositParms: function(escrowIdBN, productIdBN, surchargeBN, attachmentIdxBN, messageHex) {
