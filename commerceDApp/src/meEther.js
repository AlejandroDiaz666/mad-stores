...
const meEther = module.exports = {
	...
	meEther.MEContractInstance.vendorAccounts(addr, (err, resultObj) => {
	    ...
	    if (!err) {
		//result = { true, 0 }
		const keys = [ 'deliveriesApproved', 'deliveriesRejected', 'serviceRegion', 'activeFlag' ];
