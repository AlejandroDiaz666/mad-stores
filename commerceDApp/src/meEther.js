...
const meEther = module.exports = {
	...
	if (!meEther.MEContractInstance)
	    initContractInstance();
	meEther.MEContractInstance.getRegionProducts(vendorAddr, common.BNToHex256(categoryBN), common.BNToHex256(regionBN), common.BNToHex256(maxPriceBN),
						     common.BNToHex256(productStartIdxBN), common.NumberToHex256(maxResults), onlyAvailable, (err, result) => {
...
function initDaiInstance() {
    ...
    console.log('meEther.initDaiInstance: contract addr: ' + meEther.ME_CONTRACT_ADDR);
    meEther.daiInstance = daiContract.at(meEther.ME_CONTRACT_ADDR);
}
