...
var shop = module.exports = {
	...
	catUtil.addTlcOptionsElems(categoryBN, shopCategoryTlcSel);
	catUtil.addLlcBitsOptionsElems(shopCategoryTlcSel.value, categoryBN, shopCategoryLlcBitsSel, null);
